      ...
      <div className="bg-paper-card dark:bg-night-card text-ink dark:text-chalk w-[95%] md:w-full max-w-md border-3 border-ink dark:border-chalk rounded-3xl shadow-soft p-6 relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
             ...
             {isFuture && <span className="text-xs font-bold uppercase tracking-widest text-[var(--color-accent)]">Future Planning</span>}
             {isPast && <span className="text-xs font-bold uppercase tracking-widest opacity-50">History</span>}
          </div>
        ...
        <div className="space-y-6">
                ...
                {tasks.map((task, idx) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isMissed ? (
                                <span className="text-[10px] uppercase font-black text-rose-500 tracking-wider">Incomplete</span>
                            ) : (
                                <button 
          ...
          {!isFuture && (
              <div>
                <label className="block font-bold text-lg mb-3 mt-6">Journal Notes</label>
                <textarea
                  rows="3"
          ...
          <div className="flex gap-4 pt-4 border-t-2 border-ink/5 mt-4">
            ...
            >
               {isUploading 
                  ? 'Saving...' 
                  : isFuture 
                    ? (existingData ? 'Update Plan' : 'Save Plan') 
